...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            writer.writerow([
                "Project id", "Submission_id", "PO detail URL", "Consultant Name", "Total Hours"
            ])
            ...
            for project in projects:
                ...
                writer.writerow(
                    [project.id, project.submission.id, f"{config.APP_URL}#/details/{project.submission.id}/project?id={project.id}",
                    project.submission.consultant.name, project.associate.total_hours]
                )
