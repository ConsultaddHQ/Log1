...
# from finance.models import TimeSheet, ConsultantLeave, Leave
...
from project.models import Project, ProjectOrder, ProjectSupport, SupportStatus, PayrollSchedule, \
    ProjectStatus, ProjectPaymentTerm , TimeSheet, ConsultantLeave, Leave
